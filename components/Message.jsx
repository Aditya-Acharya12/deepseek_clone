  ...
  return (
    <div className='flex flex-col items-center w-full max-w-3xl text-sm'>
        <div className = {`flex flex-col w-full mb-8 ${role === 'user' && 'items-end'}`}>
            ...
            <div className={`group relative flex max-w-2x1 py-3 rounded-xl ${role === 'user' ? 'bg-[#414158] px-5' : 'gap-3'}`}>
                ...
                </div>
                {
                    ...
                    (
                        <>
                        <Image src={assets.logo_icon} alt='' className='w-8 h-8 rounded-full p-1 border border-white/15 ' />
